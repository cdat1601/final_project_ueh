<div class="container-fluid ">
        ...
        <div class="col-12 col-sm-12 col-md-12  col-lg-4 col-xl-4">
            ...
            <div class="row" style="text-align: center;">
                <div class="col" id="ftr-image">
                    <img class="ftr-image" src="public/images/logo/logo.png" alt="">
                </div>
            </div>
            <div class="row">
                <div class="col">
                    <h2 class="ftr-shopname">CODA</h2>
                </div>
            </div>
        </div>
        <div class="col-12 col-sm-12 col-md-12  col-lg-8 col-xl-8" style="padding: 0px;">
            <div class="row no-gutters" style="width: 100%; z-index: 5;" id='hidwmd'>
                <div class="col ftr-whitespace"></div>
            </div>
            <div class="row ">
            ...
            <div class="row">
                <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                    <p class="ftr-copyright">© 2023 CODA, Inc. All Rights Reserved</p>
    ...
    <div id="back-to-top">
        ...
        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-up-square-fill backtotop" viewBox="0 0 16 16">
